function [st,t,f] = StockwellTransform(timeseries, minfreq, maxfreq, samplingrate, freqsamplingrate)
...
% This is the S transform wrapper that holds default values for the function.
    ...
    if verbose
        fprintf('The number of frequency voices is %d',spe_nelements)
    end
...
%-----------------------------------------------------------------------
    ...
    if verbose
        fprintf('Estimated time is %f',tim_est)
    end
